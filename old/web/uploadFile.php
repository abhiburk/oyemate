...
if($_REQUEST['xAction'] == 'uploadFile')
{
		if($uploadDoc != '')
	{
				...
				if (in_array($fileExtension, $validExtensions)) 
		{
				...
				$sql = "INSERT INTO upload (userID,uploadDoc,detail,uploadTime) values ('".$_SESSION['userid']."','".mysql_real_escape_string($uploadDoc)."','".mysql_real_escape_string($detail)."','".$time."')";		
		 }
				...
				$sql = "INSERT INTO upload (userID,detail,uploadTime) values ('".$_SESSION['userid']."','".mysql_real_escape_string($detail)."','".$time."')";		
		 }
