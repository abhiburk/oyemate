...
<head>
<title>My College : Skymate</title>
      ...
      <div class="main_content floatleft">
        ...
        <div class="left_coloum floatleft" >
          ...
          <div class="text_area_home other">
            <div class="content-right">
              ...
              <div class="cntnt-img" style="background-image:url(<?php echo '../uploads/'.$rowCollege['collegePhoto']; ?>)">
                <?php } ?>
              </div>
              <div class="bnr-img">
                <?php if($user['userImg']=='') { 
          ...
          <div class="single_left_coloum_wrapper ">
            ...
            <form id="myform" action="insertData.php" method="post" enctype="multipart/form-data">
              ...
              <div class="text_area_home hideHome">
                <h3>* Institute Name: <small class="font"><?php echo $rowCollege['instituteName']; ?> </small> <a class="floatright showInstituteField" href="#" rel="<?php echo $rowCollege['userID']; ?>" >Edit</a>
                  <textarea class="form-control hideTextareaInstitute<?php echo $rowCollege['userID']; ?> hideInstitute" name="instituteName" placeholder="Enter Name of Institute" required="required" /></textarea>
                </h3>
              </div>
              <div class="text_area_home hideHome">
                <h3>* Institute Code: <small class="font"><?php echo $rowCollege['collegeCode']; ?></small> <a class="floatright showCodeField" href="#" rel="<?php echo $rowCollege['userID']; ?>" >Edit</a>
                  <input type="text" class="form-control hideInputCode<?php echo $rowCollege['userID']; ?> hideCode" name="collegeCode" placeholder="Institute Code" required />
                </h3>
              </div>
              <div class="text_area_home hideHome">
                <h3> Address: <small class="font"><?php echo $rowCollege['collegeAddress']; ?> </small> <a class="floatright showAddressField" href="#" rel="<?php echo $rowCollege['userID']; ?>" >Edit</a>
                  <textarea class="form-control hideTextareaAddress<?php echo $rowCollege['userID']; ?> hideAddress" name="collegeAddress" placeholder="Enter Address of Institute" />
                  </textarea>
                </h3>
              </div>
              <div class="text_area_home hideHome">
                <h3> Contact Info: <small class="font"><?php echo $rowCollege['collegeContact']; ?></small> <a class="floatright showContactField" href="#" rel="<?php echo $rowCollege['userID']; ?>" >Edit</a>
                  <input type="text" class="form-control hideInputContact<?php echo $rowCollege['userID']; ?> hideContact" name="collegeContact" placeholder="Institute Contact Info" value="<?php echo $rowCollege['collegeContact']; ?>" />
                </h3>
              </div>
              <div class="text_area_home hideHome">
                <h3> Website: <small class="font"><?php echo $rowCollege['collegeWebsite']; ?></small> <a class="floatright showWebsiteField" href="#" rel="<?php echo $rowCollege['userID']; ?>" >Edit</a>
                  <input type="text" class="form-control hideInputWebsite<?php echo $rowCollege['userID']; ?> hideWebsite" name="collegeWebsite" placeholder="Institute Website" value="<?php echo $rowCollege['collegeWebsite']; ?>" />
                </h3>
              </div>
              <div class="text_area_home hideHome">
                <h3> Director: <small class="font"><?php echo $rowCollege['collegeDirector']; ?></small> <a class="floatright showDirectorField" href="#" rel="<?php echo $rowCollege['userID']; ?>" >Edit</a>
                  <input type="text" class="form-control hideInputDirector<?php echo $rowCollege['userID']; ?> hideDirector" name="collegeDirector" placeholder="Institute Director" value="<?php echo $rowCollege['collegeDirector']; ?>" />
                </h3>
              </div>
        ...
        <script>
            ...
            $.ajax({
                ...
                data: formData,
                success: function() {
           		window.location = "myCollege.php?reqSent=1";
                }});
				})
		</script>
        <?php if($user['instituteName']=='Other') { ?>
