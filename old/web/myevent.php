        ...
        <div class="left_coloum floatleft" >
            ...
            <h3 id="fade1" align="center" style="color:#FFF; font-size:12px">Student Added Successfully </h3>
               ...
               <?php $event_query=mysqli_query($dbconfig,"SELECT * FROM events LEFT JOIN user ON 
		  		events.userID=user.userID WHERE (events.eventID='".$_REQUEST['eventID']."')");
		  ...
		  ?>
		    ...
		    ?>
            <p><b><a href="user/<?php echo $rowCO['userID'];?>"><?php echo $rowCO['userName']; ?></b> <a class="floatright" href="delete.php?webName=<?php echo $_REQUEST['webName']; ?>&coordinateID=<?php echo $rowCO['coID']; ?>&xAction=removeCo" rel="<?php echo $rowCO['coID']; ?>">Remove</a> </p>
            <?php } ?>
          </div>
               <script>
	$(function() {
     ...
     source: 'searchStudent.php?xAction=<?php echo 'searchCo'; ?>'
            ...
            <form method="post" enctype="multipart/form-data">
                ...
                <div class="left-margin ">
                       ...
                       <textarea class="form-control hideInputMessage<?php echo $row_event['userID']; ?> hideMessage" name="textMessage" placeholder="Enter the text message or Instruction you want to show to the user who regeisterd successfully to your event. Eg: Thankyou for Registering, we will contact you soon for next details" />
                       <?php echo $row_event['textMessage']; ?>
                       </textarea>
                     </div>
              </div>
