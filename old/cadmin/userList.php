...
<html>
<head>
<title>User List | Admin :: clapdust</title>
...
<div class="agile-grids">	
				...
				<div class="agile-tables">
				  ...
				  <table id="table-two-axis" class="two-axis">
					...
					<tbody>
                     <?php 
						$sql=mysqli_query($dbconfig,"SELECT * FROM user ORDER BY userID DESC");
						while($userInfo=mysqli_fetch_assoc($sql)){
							
						$sql1=mysqli_query($dbconfig,"SELECT * FROM storyViews GROUP BY ipaddress");
						$countViews=mysqli_num_rows($sql1);
						?>
					  <tr>
                      ...
                      <a href="delete.php?xAction=deleteUser&userID=<?php echo $userInfo['userID']; ?>" class="confirmDelete">Delete</a>
						...
						<td><?php echo $userInfo['userPass']; ?></td>
                        
						<td><?php date_default_timezone_set('Asia/Kolkata'); echo date('d / m / Y',$userInfo['time']); ?></td>
					  </tr><?php } ?>
					</tbody>
				  </table>
