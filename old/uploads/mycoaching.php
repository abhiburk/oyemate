          ...
          <div class="text_area_home">
            <div class="content-right">
              ...
              <div class="bnr-text">
                ...
                <h1><a href="coaching.php?ci_ID=<?php echo $rowCollege['ci_ID']; ?>"><?php echo $rowCollege['instituteName']; ?></a></h1>
                <h3>
              ...
              <form method="post" enctype="multipart/form-data">
                ...
                <div class="text_area_home hideHome">
                  <h3> Address: <small class="font"><?php echo $rowCollege['ci_Address']; ?> </small> <a class="floatright showAddressField" href="#" rel="<?php echo $rowCollege['userID']; ?>" >Edit</a>
                    <textarea class="form-control hideTextareaAddress<?php echo $rowCollege['userID']; ?> hideAddress" name="ci_Address" placeholder="Enter Address of Institute" />
                    <?php echo $rowCollege['ci_Address']; ?>
                    </textarea>
                  </h3>
                </div>
