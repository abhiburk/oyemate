...
WHERE attend_students.attend_StudID='".$_REQUEST['attend_StudID']."' AND userID='".$_SESSION['userid']."'");
    ...
    <div class="content_area">
      <div class="main_content floatleft">
        ...
        <div id="fade" style="background-color:#0C0;">
          <h3 id="fade1" align="center" style="color:#FFF; font-size:15px">Data Updated Successfully </h3>
        </div>
        <?php } ?>
        <?php 
        ...
        <table class="table table-striped table-bordered table-hover">
          ...
          <tr>
            <form action="insertData.php" method="post" enctype="multipart/form-data">
              ...
              <input type="hidden" name="attend_StudID" value="<?php echo $_REQUEST['attend_StudID'] ?>" />
              <td><?php if($attend_user['userID']==''){ ?>
                ...
                <?php }else{ ?>
                Present:
                <input type="radio" name="attendStatus" value="present"<?php if($row_students['attendStatus'] == 'present'){ echo 'checked';}?>/>
                | Absent:
                <input type="radio" name="attendStatus" value="absent" <?php if($row_students['attendStatus'] == 'absent'){ echo 'checked';}?>/>
                <?php } ?></td>
              <?php 
