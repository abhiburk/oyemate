    ...
    <div class="content_area">
      <div class="main_content floatleft">
        ...
        <div class="left_coloum floatleft" >
          ...
          <div class="text_area_home">
             <textarea class="form-control" name="logincontactMessage" placeholder="Message here" /></textarea>
          </div>
        <div class="text_area_home">
		...
		$count=mysqli_num_rows($sql_contact);
		if($count==0){echo 'No Contact Us Messages';}else {
