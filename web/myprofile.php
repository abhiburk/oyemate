  ...
  <div class="center">
          ...
          <div class="single_left_coloum_wrapper fileDiv">
            ...
            <div class="text_area_home">
              <div class="left-margin">
                <p class="floatright"> <?php echo "" . humanTiming( $uploaded['uploadTime'] ). " ago"; ?> </p><br/>
                ...
                <h3 class="floatright"><a class="content" title="<?php echo $uploaded['uploadDoc']; ?>" href="download.php?fileDetail=<?php echo $uploaded['uploadDoc']?> &uploadID=<?php echo $uploaded['uploadID']?>"> Download
                  <?php $str=$uploaded['uploadDoc']; if(strlen($str)>=25){ echo substr($str,0,30).'...';}else{echo $str; }?></a> </h3>
                <h3><?php echo $uploaded['uploadDoc']; ?> &nbsp;
                  <ul class="dropdown"><a href="#" title="File Download Count" class=" floatright dropbtn">(<?php echo $uploaded['downloadCount']; ?>)</a>
    ...
    <div class="single_left_coloum_wrapper ">
          ...
          <div class="left-margin">
              ...
              <div class="text_area_home hideHome">
                <h3> Birthday:
				 ...
				 echo '<small class="font">';  echo $user['day']; ?>
                  / <?php echo $user['month']; ?> / <?php echo $user['year'];echo '</small>'; } ?><a class="floatright showbirthField" href="#" rel="<?php echo $user['userID']; ?>" >Edit</a>
              ...
              <div class="text_area_home hideHome">
                <h3> Institite: <small class="font"><?php echo $user['instituteName']; ?></small>
              <?php if($user['company']== 'Coaching Staff') { ?>
              <a class="floatright showinstituteField" href="#" rel="<?php echo $user['userID']; ?>" >Edit</a>
                  	<input type="text" class="form-control hideInputInstitute<?php echo $user['userID']; ?> hideInstitute" name="instituteName" value="<?php echo $user['instituteName']; ?>" />
              <?php }else { ?>
                  	<input type="text" class="form-control hideInputInstitute<?php echo $user['userID']; ?> hideInstitute" name="instituteName" value="<?php echo $user['instituteName']; ?>" />
              <a class="floatright" title="You cannot edit this due to privacy concern">Info</a>  <?php } ?>
             </h3> </div>
        ...
        <script>
            ...
            $.ajax({
                ...
                success: function (response) {
  				document.getElementById("profileUpdated").innerHTML=response; 
		...
		$(document).ready(function(){
			...
			$("input.hideInstitute").hide();
			$("a.showinstituteField").click(function(){
			var userID= $(this).attr('rel');
			$("input.hideInputInstitute"+userID).toggle(500);
			return false;	
			});
});
        </script> 
