...
$sql_created=mysqli_query($dbconfig,"SELECT * FROM attend_sheets WHERE sheetID='".$_REQUEST['sheetID']."' AND userID='".$_SESSION['userid']."'");
...
$(function() {
    $( "#studentName" ).autocomplete({
        source: 'searchStudent.php?sheetID=<?php echo $_REQUEST['sheetID']; ?>&xAction=<?php echo 'searchStudent'; ?>'
          ...
          <?php 
				$sql_created=mysqli_query($dbconfig,"SELECT * FROM attend_subjects LEFT JOIN attend_sheets ON attend_subjects.sheetID=attend_sheets.sheetID
				WHERE attend_subjects.sheetID='".$_REQUEST['sheetID']."' AND userID='".$_SESSION['userid']."'") or mysqli_error();
          ...
          <div class="text_area_home">
          <p align="center">Added Students</p>
          </div>
          <?php
$start=0;
$limit=5;
...
?>
            <table class="table table-striped table-bordered table-hover">
              ...
              <?php 
				...
				WHERE sheetID='".$_REQUEST['sheetID']."' ORDER BY attend_StudID DESC LIMIT $start,$limit");
              ...
              <tr>
                ...
                <td><div class=""> <a class="showStudentField" href="#" rel="<?php echo $row_students['attend_StudID']; ?>" >Edit</a> | <a class="confirmDelete" href="delete.php?xAction=deleteStudent&attend_StudID=<?php echo $row_students['attend_StudID']; ?>&sheetID=<?php echo $_REQUEST['sheetID']; ?>" >Delete</a> </div></td>
              </tr>
              <?php } ?>
            </table>
            <?php
