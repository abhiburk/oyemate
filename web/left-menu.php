    ...
    <div id="unsubSuccess"></div>
      <div class="text_area_home">
        <div class="left-menu-margin">
          ...
          <?php }else { ?>
          <?php 
		  $notification=mysqli_query($dbconfig,"SELECT * FROM improve_us
		  WHERE userID='".$_SESSION['userid']."' AND readStatus='unread'");
          ...
          <?php } ?>
          <p class="sub-menu"><b> <b><a href="setting.php">Settings</a></p>
