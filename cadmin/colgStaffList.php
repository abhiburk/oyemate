...
<html>
<head>
<title>College Staffs | Admin :: clapdust</title>
      ...
      <div class="agile-tables">
        <div class="w3l-table-info">
          ...
          <table id="table-two-axis" class="two-axis">
            ...
            <tbody>
              <?php 
						$sql=mysqli_query($dbconfig,"SELECT * FROM user WHERE company='College Staff' ORDER BY userID DESC");
