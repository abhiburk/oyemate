...
<html>
<head>
<title>Search Result | Admin :: clapdust</title>
...
<div class="left-content">
  <div class="mother-grid-inner"> 
    ...
    Search Result For "<b><?php echo $searchVal ?></b>" <br>
    <!--FAQ-->
   		 <?php
				$sql3=mysqli_query($dbconfig,"SELECT * FROM faq 
				WHERE question LIKE '%".mysql_real_escape_string($searchVal)."%' OR 
				faqName LIKE '%".mysql_real_escape_string($searchVal)."%' OR question LIKE '%".mysql_real_escape_string($searchVal)."%' OR 
				...
				$searchVal3 = mysqli_num_rows($sql3);
					...
					$searchVal1 = mysqli_num_rows($sql1);
						...
						if($searchVal1.''.$searchVal2.''.$searchVal3 == 0){ 
    ...
    <div class="asked">
      ...
      <div class="questions">
        ...
        <h6> Asked by: <b><?php echo $faqList['faqName']; ?></b>
          <?php if($faqList['userID']!='0'){ ?>
          (Member)
          <?php } ?>
          ,
          <?php date_default_timezone_set('Asia/Kolkata');echo "" . humanTiming( $faqList['time'] ). " ago"; ?>
          , <a href="#" rel="<?php echo $faqList['faqID']; ?>" class="answer" >Answer this</a> </h6>
        <div class="hideArea<?php echo $faqList['faqID']; ?> hideAll">
          <form id="myForm"  method="post" enctype="multipart/form-data">
            ...
            <textarea class="form-control" class="answer1" name="answer" placeholder="Answer to this question" >
            </textarea>
              ...
              <tr>
                ...
                <td><?php if($userInfo['deleteReq']=='yes' OR $userInfo['deleteReq']== 'yes(read)'){ ?>
                  <?php 		$time=time();
						...
						?>
                  <small class="showExpire"><i class="glyphicon glyphicon-time" style="color:#F00"></i>Timeout</small><br>
                  | <a href="#" rel="<?php echo $userInfo['reqID']; ?>" class="reject"> Reject Request</a> | <a href="#" rel="<?php echo $userInfo['reqID']; ?>" class="confirmDelete">Delete</a> |
                  <?php }else { ?>
